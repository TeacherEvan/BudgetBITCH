...
export const localeMessages = {
  en: {
    ...
    signUp: {
      ...
      passwordLabel: "Password",
      privacy:
        "Use at least 8 characters. Password reset and email verification are not enabled in this first pass.",
    },
    authContinue: {
      eyebrow: "Continue",
  ...
  zh: {
    ...
    signIn: {
      ...
      emailLabel: "邮箱",
      passwordLabel: "密码",
      privacy: "用户不需要添加环境文件。应用所有者只需配置一次 Convex，用户就在这里登录。",
      setupRequiredTitle: "尚未配置 Convex Auth",
      setupRequiredDescription: "请先连接 Convex 部署，再使用此登录方式。",
    },
    signUp: {
      eyebrow: "创建账户",
      title: "创建你的预算账户",
      ...
      emailLabel: "邮箱",
      passwordLabel: "密码",
      privacy: "请至少使用 8 个字符。此第一版尚未启用密码重置和邮箱验证。",
    },
    authContinue: {
      eyebrow: "继续",
    ...
    securitySettings: {
      ...
      openGooglePermissions: "密码重置和邮箱验证是后续计划。",
      sessionAccessEyebrow: "会话访问",
      sessionAccessTitle: "安全切换账户。",
      sessionAccessDescription:
        "如果你需要返回登录页面并使用其他账户，请在这里退出登录。",
      privacyEyebrow: "隐私",
      privacyItems: {
