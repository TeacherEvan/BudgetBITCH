...
const devCommand = stripAuth
  ? "BUDGETBITCH_STRIP_AUTH_ENV=true node ./scripts/run-with-sanitized-env.mjs node ./node_modules/next/dist/bin/next dev -p 3100"
  : "node ./scripts/run-with-sanitized-env.mjs node ./node_modules/next/dist/bin/next dev -p 3100";
